...
</section> <section className="howItWorks">
...
<section className="faqSection">
  ...
  <div className="faqGrid">
    <div className="faqItem">
      <h3>Virker AdPilot til alle virksomheder?</h3>
      <p>Ja. Den kan bruges til webshops, lokale firmaer, klinikker, håndværkere, restauranter, freelancere og bureauer.</p>
    </div>

    <div className="faqItem">
      <h3>Skal jeg kunne marketing?</h3>
      <p>Nej. Du udfylder bare en kort brief, og AdPilot laver struktur, tekster og annonceidéer for dig.</p>
    </div>

    <div className="faqItem">
      <h3>Er output klar til brug?</h3>
      <p>Ja. Teksterne er lavet til copy/paste og kan bruges som annoncer, kampagnebrief eller kundeoplæg.</p>
    </div>

    <div className="faqItem">
      <h3>Kan bureauer bruge det?</h3>
      <p>Ja. Det er oplagt til hurtige kampagneforslag, pitchmateriale og annonceidéer til kunder.</p>
    </div>
  </div>
</section>
